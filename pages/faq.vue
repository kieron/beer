<template>
  <div class="p-4 mt-6">
    <h4
      class="text-4xl font-bold text-gray-800 tracking-widest uppercase text-center"
    >
      FAQ
    </h4>
    ...
    <div class="space-y-12 px-2 xl:px-16 mt-12">
        ...
        <div>
          ...
          <div class="flex items-center py-2">
            <span class="text-gray-500"
              ...
              impedit iusto vitae dolorum. Nostrum, fugit!</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="mt-4 flex">
        ...
        <div>
          <div class="flex items-center h-16">
            <span class="text-lg text-gray-600 font-bold"
              >Neque eos, dignissimos provident reiciendis debitis?</span
            >
          </div>
          <div class="flex items-center py-2">
            <span class="text-gray-500"
      ...
      <div class="mt-4 flex">
        ...
        <div>
          <div class="flex items-center h-16">
            <span class="text-lg text-gray-600 font-bold"
              >Repudiandae commodi perferendis et itaque?</span
            >
          </div>
          <div class="flex items-center py-2">
            <span class="text-gray-500"
