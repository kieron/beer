  ...
  <div>
    <main class="profile-page">
      <section class="relative block h-52 md:h-96">
        <div
          class="absolute top-0 w-full h-full bg-center bg-cover md:bg-[url('https://images.unsplash.com/photo-1499336315816-097655dcfbda?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2710&q=80')]"
        >
          <span
            id="blackOverlay"
        ...
        >
          ...
          >
            <polygon
              class="text-amber-100 fill-current"
