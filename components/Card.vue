  ...
  <div class="relative w-full">
    ...
    >
      <div class="rounded-lg">
        <div
          class="relative flex h-50 justify-center overflow-hidden rounded-lg"
        >
          <div
        ...
        <div class="">
          <div class="mt-4 grid grid-cols-2">
            ...
            <div class="hidden flex items-center justify-end">
              <p
          ...
          <div class="mt-2 border-t border-gray-900 pt-3">
          ...
          <div
            class="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-b border-t border-gray-900 pb-3 pt-3"
          >
            <p
              class="flex items-center text-gray-800 xl:flex-row xl:items-center"
            >
              <svg
                class="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
              ...
              <span class="xl:mt-0"> Parking </span>
            </p>
            <p
              class="flex items-center text-gray-800 xl:flex-row xl:items-center"
            >
              ...
              <span class="mt-0"> Outdoor Seating </span>
            </p>
            <p
              class="flex items-center text-gray-800 xl:flex-row xl:items-center"
            >
            ...
            >
              ...
              <span class="mt-0"> Live Music </span>
            </p>
          </div>
        </div>
      </div>
